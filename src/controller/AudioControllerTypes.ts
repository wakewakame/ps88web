...
export const isSaveDataBytes = (data: SaveData): data is SaveDataBytes => (data?.type === "bytes");
export type SaveDataText = { type: "string"; data: string; };
export const isSaveDataText = (data: SaveData): data is SaveDataText => (data?.type === "string");
